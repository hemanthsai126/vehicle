...
# Streamlit interface
st.title("Zoox – Issue Prediction Tool")

# Create a layout with three columns (left, center, right)
left_col, center_col, right_col = st.columns([1, 2, 1])

# Display images in the left and right columns
with left_col:
    st.image("zoo.png", use_column_width=True)  # Replace with your left image file path

with right_col:
    st.image("zoo.png", use_column_width=True)  # Replace with your right image file path

# Center column for inputs and predictions
with center_col:
